...
[![GitHub stars](https://img.shields.io/github/stars/RealBeBetter/bilibili-helper?style=flat-square)](https://github.com/RealBeBetter/bilibili-helper/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/RealBeBetter/bilibili-helper?style=flat-square)](https://github.com/RealBeBetter/bilibili-helper/network)
[![GitHub issues](https://img.shields.io/github/issues/RealBeBetter/bilibili-helper?style=flat-square)](https://github.com/RealBeBetter/bilibili-helper/issues)
[![GitHub license](https://img.shields.io/github/license/RealBeBetter/bilibili-helper?style=flat-square)](https://github.com/RealBeBetter/bilibili-helper/blob/main/LICENSE)
[![GitHub All Releases](https://img.shields.io/github/downloads/RealBeBetter/bilibili-helper/total?style=flat-square)](https://github.com/RealBeBetter/bilibili-helper/releases)
...
[![GitHub contributors](https://img.shields.io/github/contributors/RealBeBetter/bilibili-helper?style=flat-square)](https://github.com/RealBeBetter/bilibili-helper/graphs/contributors)
![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/RealBeBetter/bilibili-helper?style=flat-square)
...
**仓库地址：[RealBeBetter/bilibili-helper](https://github.com/RealBeBetter/bilibili-helper)**
...
请参考[腾讯云函数部署](https://github.com/RealBeBetter/bilibili-helper/blob/main/docs/scf.md)

### 二、使用 Docker

请自行参阅 [Issues/75#issuecomment-731705657][28] 和[基于本项目的衍生项目](#基于本项目的衍生项目)。

[28]: https://github.com/RealBeBetter/bilibili-helper/issues/75#issuecomment-731705657
...
```
wget https://raw.githubusercontent.com/RealBeBetter/bilibili-helper/main/setup.sh && chmod +x ./setup.sh && sudo ./setup.sh
```
...
[30]: https://github.com/RealBeBetter/bilibili-helper/releases/latest
[31]: https://github.com/RealBeBetter/bilibili-helper/blob/main/start.sh
...
6. 本工具源码仅在[RealBeBetter/bilibili-helper](https://github.com/RealBeBetter/bilibili-helper)开源，其余的地方的代码均不是我提交的，可能是抄我的，借鉴我的，但绝对不是我发布的，出问题和我也没关系。
...
10. 本项目遵守[MIT License](https://github.com/RealBeBetter/bilibili-helper/blob/main/LICENSE)，请各位知悉。
